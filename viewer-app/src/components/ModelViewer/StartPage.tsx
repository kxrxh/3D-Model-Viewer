				...
				>
					<div className="flex items-center gap-3 px-6 py-4 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl shadow-lg max-w-2xl">
						...
						<p className="text-base">
							<span className="font-semibold">Модель загружена.</span>{" "}
							Пожалуйста, загрузите файл инструкций (.json)
						</p>
					</div>
				</motion.div>
			)}
			...
			{!hasModel && hasInstructions && (
				...
				>
					<div className="flex items-center gap-3 px-6 py-4 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl shadow-lg max-w-2xl">
						<FiAlertCircle className="text-amber-500 flex-shrink-0" size={24} />
						<p className="text-base">
							<span className="font-semibold">Инструкции загружены.</span>{" "}
							Пожалуйста, загрузите файл модели (.glb, .gltf)
						</p>
					</div>
				</motion.div>
			)}
