		...
		const handleDragMove = (e) => {
			...
			if (insertIndex !== -1) {
				...
				if (currentIndex !== -1 && currentIndex !== insertIndex) {
					const newStates = assemblyStates.filter(
		...
		<>
				...
				<div className="space-y-4">
					...
					{assemblyStates.length === 0 ? (
						<div className="text-center py-6 text-gray-500 italic">
							Нет созданных сборок. Создайте новую сборку, нажав кнопку
							"Добавить сборку".
						</div>
					) : (
										...
										<div className="flex-1">
											<div className="flex items-center justify-between mb-2">
												...
												<span className="ml-2 text-xs px-2 py-0.5 bg-gray-100 text-gray-700 rounded-full">
													{state.parts.length}{" "}
													{state.parts.length === 1 ? "часть" : "частей"}
												</span>
											</div>
											...
											<div className="flex gap-1.5 mb-1.5">
												...
												<button
													onClick={() =>
														onStateSelect(
															currentStateIndex === index ? -1 : index,
														)
													}
				...
				<Widget
					title={
						editingStateIndex !== null
							? `Выбор частей: ${assemblyStates[editingStateIndex].name}`
							: "Выбор частей"
					}
			...
			{showDescriptionEditor && (
				<Widget
					title={
						editingStateIndex !== null
							? `Описание этапа: ${assemblyStates[editingStateIndex].name}`
							: "Описание этапа"
					}
				...
				>
					<div className="space-y-4">
						<div className="text-sm text-gray-600 mb-2">
							Введите описание или используйте микрофон для голосового ввода
